  ...
  return (
    <main>
      ...
      <Card className="mx-[10vw] my-[10vh] md:mx-[30vw] md:my-[15vh]">
        <Link
          href="/dashboard"
          className="text-muted-foreground pl-4 pt-6 text-sm flex items-center transition-colors hover:text-primary"
        >
          <IoMdArrowRoundBack /> Back
        </Link>
        <CardHeader className="flex flex-col items-center justify-center space-y-0 pb-2">
          <CardTitle className="text-start text-2xl font-medium">
